...
public class EntryArea {
    ...
    public EntryArea(ObservableList<TelefonEntry> telefonEntries) {
        ...
        firstNameCol.setMaxWidth( 1f * Integer.MAX_VALUE * 35 ); // 35% width
        lastNameCol.setMaxWidth( 1f * Integer.MAX_VALUE * 35 ); // 35% width
        emailCol.setMaxWidth( 1f * Integer.MAX_VALUE * 30 ); // 30% width
